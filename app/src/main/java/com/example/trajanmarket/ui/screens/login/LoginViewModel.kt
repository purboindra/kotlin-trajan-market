...
class LoginViewModel @Inject constructor(
    ...
    private val _loginState = MutableStateFlow<State<HttpResponse>>(State.Idle)
    val loginState: StateFlow<State<HttpResponse>> = _loginState
    ...
    private val _showPassword = MutableStateFlow<Boolean>(false)
